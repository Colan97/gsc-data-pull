...
def login_clicked():
    ...
    try:
        ...
        # Open the authorization_url in a new tab instead of using meta refresh
        st.markdown(f'<a href="{authorization_url}" target="_blank">Click here to authorize with Google</a>', unsafe_allow_html=True)
        st.info("After authorizing, please return to this tab to continue.")
    except Exception as e:
